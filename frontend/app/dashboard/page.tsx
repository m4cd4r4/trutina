      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="rounded-xl border border-white/10 overflow-hidden"
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
            <h2 className="font-semibold text-white/80">Recent Cases</h2>
          ...
          {loading ? (
            ...
            <div className="p-8 text-center text-white/30">No cases yet. <Link href="/cases/new" className="text-blue-400 hover:underline">Create one.</Link></div>
          ) : (
