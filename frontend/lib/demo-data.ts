...
export const DEMO_CASES: DemoCase[] = [
  // ── 1. Clean legitimate application ──────────────────────────
  {
    ...
    documents: [
      { id: 'd1', doc_type: 'payslip', filename: 'sharma_payslip_jan2026.pdf', status: 'analysed', page_count: 1 },
      { id: 'd2', doc_type: 'bank_statement', filename: 'sharma_nab_dec2025.pdf', status: 'analysed', page_count: 4 },
    ],
    summary: 'All documents appear genuine. Payslip produced by Xero with consistent metadata. ABN 91234567890 (Sharma & Co Architects) is active and matches employer name. Gross, tax, and super calculations are internally consistent. Bank statement salary credits align with claimed income. No AI-generation indicators detected.',
    flags: [
  ...
  // ── 2. AI-generated payslip — critical rejection ─────────────
  {
    ...
    documents: [
      { id: 'd3', doc_type: 'payslip', filename: 'kowalski_payslip_jan2026.pdf', status: 'analysed', page_count: 1 },
    ],
  ...
  // ── 4. Bank statement forgery — balance mismatch ─────────────
  {
    ...
    documents: [
      { id: 'd6', doc_type: 'payslip', filename: 'chen_payslip_jan2026.pdf', status: 'analysed', page_count: 1 },
      { id: 'd7', doc_type: 'bank_statement', filename: 'chen_cba_dec2025.pdf', status: 'analysed', page_count: 3 },
    ],
  ...
  // ── 5. Broker network cluster ────────────────────────────────
  {
    ...
    documents: [
      { id: 'd8', doc_type: 'payslip', filename: 'mitchell_payslip_jan2026.pdf', status: 'analysed', page_count: 1 },
    ],
    summary: 'The individual payslip passes most checks — it was produced by KeyPay, the math is consistent, and the ABN is active. However, Trutina\'s broker network analysis reveals that Fast Track Finance has submitted 4 applications in the past 7 days, all claiming the same employer (ABN 89012345678, "Pacific Coast Staffing"). This pattern is consistent with a broker fabricating employment at a compliant shell company. Recommend verifying Sarah Mitchell\'s employment directly with Pacific Coast Staffing via an independent channel.',
    flags: [
      ...
      flag('f19', 'broker_risk', 'SHARED_EMPLOYER_CLUSTER', 'Multiple applications share the same employer',
        'This is the 4th application from Fast Track Finance in 7 days where the applicant claims employment at "Pacific Coast Staffing" (ABN 89012345678). Applicants: Li Wei (TT-2026-00035), Ahmed Hassan (TT-2026-00036), Rachel Kim (TT-2026-00037), Sarah Mitchell (TT-2026-00038). Four unrelated individuals all employed by the same small staffing company and all applying for loans through the same broker is statistically anomalous.',
        'high', 7, { employer: 'Pacific Coast Staffing', abn: '89012345678', linked_cases: ['TT-2026-00035', 'TT-2026-00036', 'TT-2026-00037', 'TT-2026-00038'], applicants: ['Li Wei', 'Ahmed Hassan', 'Rachel Kim', 'Sarah Mitchell'] }),
