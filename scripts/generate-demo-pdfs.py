...
def gen_sharma_bank():
    ...
    pdf.add_page()
    pdf.add_account_info('Priya R Sharma', '086-174', '4738 29156', '01 Dec 2025 - 31 Dec 2025')
    pdf.add_summary(3842.16, 9215.40, 8647.93, 4409.63)

    txns = [
        ('01/12', 'Opening Balance', None, None, 3842.16),
        ('02/12', 'Westfield Health - Salary', None, 4378.85, 8221.01),  # employer unchanged
    ...
    pdf.output(os.path.join(OUT, 'sharma_nab_dec2025.pdf'))


# ─── CASE 2: AI Fake (David Kowalski) ───

def gen_kowalski_ai_payslip():
...
def gen_chen_bank():
    ...
    pdf.add_page()
    pdf.add_account_info('James W Chen', '062-000', '1029 3847', '01 Dec 2025 - 31 Dec 2025')
    ...
    txns = [
        ...
        ('27/12', 'Transfer - J.Chen', None, 3198.17, 10907.35),
    ...
    pdf.output(os.path.join(OUT, 'chen_cba_dec2025.pdf'))


# ─── CASE 5: Broker Cluster (Sarah Mitchell) ───
