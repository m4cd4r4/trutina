  ...
  return (
    <div className="min-h-screen text-white"
      ...
      <div id="pricing" className="max-w-6xl mx-auto px-4 sm:px-8 py-12 sm:py-16">
        ...
        {/* Trust bar */}
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mt-10 text-white/30 text-xs">
          ...
          <span className="flex items-center gap-1.5">
            <svg className="w-3.5 h-3.5 text-emerald-400/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
